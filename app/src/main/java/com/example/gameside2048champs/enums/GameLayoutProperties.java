...
public enum GameLayoutProperties {
    ...
    */
    ...
    BLOCK_MIDDLE_SQUARE_5X5_LAYOUT_PROPERTIES("BLOCK_MIDDLE_SQUARE_5X5", "1:1", 3,
            30, 30, 30, 22, 19),
    BLOCK_MIDDLE_SQUARE_6X6_LAYOUT_PROPERTIES("BLOCK_MIDDLE_SQUARE_6X6", "1:1", 2,
            27, 27, 27, 20, 16),
    BLOCK_MIDDLE_RECTANGLE_4X6_LAYOUT_PROPERTIES("BLOCK_MIDDLE_RECTANGLE_4X6", "1:1.15", 3,
            38, 38, 38, 28, 24),
    BLOCK_MIDDLE_RECTANGLE_5X6_LAYOUT_PROPERTIES("BLOCK_MIDDLE_RECTANGLE_5X6", "1:1", 2,
            32, 32, 32, 23, 20),
    BLOCK_2_CORNERS_SQUARE_5X5_LAYOUT_PROPERTIES("BLOCK_2_CORNERS_SQUARE_5X5", "1:1", 3,
            30, 30, 30, 22, 19),
    BLOCK_2_CORNERS_SQUARE_6X6_LAYOUT_PROPERTIES("BLOCK_2_CORNERS_SQUARE_6X6", "1:1", 2,
            27, 27, 27, 20, 16),
    BLOCK_2_CORNERS_RECTANGLE_4X6_LAYOUT_PROPERTIES("BLOCK_2_CORNERS_RECTANGLE_4X6", "1:1.15", 3,
            38, 38, 38, 28, 24),
    BLOCK_2_CORNERS_RECTANGLE_5X6_LAYOUT_PROPERTIES("BLOCK_2_CORNERS_RECTANGLE_5X6", "1:1", 2,
            32, 32, 32, 23, 20);
